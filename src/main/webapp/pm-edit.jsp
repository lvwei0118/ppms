...
<form name="form2" id="form14" action="${pageContext.request.contextPath}/auth/updateInfo" method="post">
   <input type="hidden" name="id" value="${sour.id}">
	<input type="hidden" name="pid" value="${sour.pid}">
...
<tr >
	...
	<input name="name" value="${sour.name}" /></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">菜单资源路径：</td>
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
	<input name="url"  value="${sour.url}"/></td>
</tr>
<tr>
	<td align="right" bgcolor="#FAFAF1" >资源描述：</td>
	<td colspan=3 align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" >
		<textarea rows=10 cols=130 name="remark">${sour.remark}</textarea>
	</td>
</tr>
