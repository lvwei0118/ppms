...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
		$(function () {
			$.ajax({
				type:"GET",
				url:"${pageContext.request.contextPath}/pos/listInfo",
            ...
            $.ajax({
                type:"GET",
                url:"${pageContext.request.contextPath}/role/listInfo",
                success:function (result) {
                    if (result!=null){
                        $(result).each(function(index,item){
							$("#role").append("<input value='"+item.roleid+"' name='roleid' type='checkbox'/>"+item.rolename+"");
...
<form name="form2"  action="${pageContext.request.contextPath}/emp/saveInfo" id="form3" method="post">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="date" name="hiredate"/></td>
</tr>
<tr >
...
<tr >
	...
	<td id="role" align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
