...
<script type="text/javascript">
    ...
    function changeImg(img){
        img.src = "/ppms/vs?time="+new Date().getTime();
    }
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写用户名 maxLength=16
														size=16 value=username id=username name="username"></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写密码 type=password
														maxLength=16 size=16 value=password id=pass name="password"></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>验证码：<span style="color: #eb0000">${errormsg}</span></FONT></TD>
													<TD><input type="text" name="userCode" value="" size="10" maxlength="6" />
														<img src="/ppms/vs" onclick="changeImg(this)"/></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
