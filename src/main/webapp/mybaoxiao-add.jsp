...
<form name="form9" action="${pageContext.request.contextPath}/bao/saveBInfo" id="form9" method="post">

<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="2" background="skin/images/tbg.gif">&nbsp;添加新的报销单&nbsp;<span style="color: #eb0000">${msg}</span></td>
</tr>
<tr >
