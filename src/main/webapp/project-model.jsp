...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
    ...
    <script type="text/javascript">
        ...
        $(function(){
            $.ajax({
                url:"${pageContext.request.contextPath}/mod/listMInfo",
                type:"GET",
                success:function(msg){
                    $(msg).each(function (index,item) {
                        var tr="<tr align='center' bgcolor='#FFFFFF' onMouseMove='javascript:this.bgColor='#FCFDEE';'onMouseOut='javascript:this.bgColor='#FFFFFF';' height='22'>"
                            ...
                            +"<td>"+item.remark+"</td>"
                            +"<td><a href='${pageContext.request.contextPath}/mod/findMById/"+item.id+"'>编辑</a> | <a href='${pageContext.request.contextPath}/mod/findMInfoById/"+item.id+"'>查看详情</a></td></tr>";
        ...
        function del(){
            ...
            $.ajax({
                url:"${pageContext.request.contextPath}/mod/delMInfo/"+ids,
                type:"POST",
        ...
        function searchLike(){
            ...
            $.ajax({
                url:"${pageContext.request.contextPath}/mod/selectMInfo",
                type:"GET",
...
<tr align="center" bgcolor="#FAFAF1" height="22">
    ...
    <%--<c:forEach items="${mouleList}" var="ml" varStatus="vs">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><input name="id" type="checkbox" id="id" value="${ml.id}" class="np"></td>
	<td>vs</td>
	<td align="center"><a href=''><u>${ml.modname}</u></a></td>
	<td align="center"><a href=''><u>${ml.analysis.title}</u></a></td>
	<td align="center"><a href=''><u>${ml.proname}</u></a></td>
	<td>${ml.level}</td>
	<td>${ml.simpledis}</td>
	<td>${ml.detaileddis}</td>
	<td><a href="${pageContext.request.contextPath}/mod/findMById/${ml.id}">编辑</a> | <a href="${pageContext.request.contextPath}/mod/findMInfoById/${ml.id}">查看详情</a></td>
</tr>
    </c:forEach>--%>
