...
<form name="form2" id="form12" action="${pageContext.request.contextPath}/msg/saveMsg" method="post">
...
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">收信息人：</td>
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="date" name="msgtime" id="time"/></td>
</tr>
<tr >
