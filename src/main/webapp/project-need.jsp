...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
    ...
    <script type="text/javascript">
                ...
                success:function(msg){
                    $(msg).each(function (index,item) {
                        var tr="<tr align='center' bgcolor='#FFFFFF' onMouseMove='javascript:this.bgColor='#FCFDEE';'onMouseOut='javascript:this.bgColor='#FFFFFF';' height='22'>"
                            ...
                            +"<td>"+item.remark+"</td>"
                            +"<td><a href='${pageContext.request.contextPath}/anal/findNById/"+item.id+"'>编辑</a> | <a href='${pageContext.request.contextPath}/anal/findNInfoById/"+item.id+"'>查看详情</a></td></tr>";
        ...
        /*条件查询*/
        function searchLike(){
            var nhid=$("select[name='nhid']").val();
            var infoKey=$("input[name='infoKey']").val();
            var orderWord=$("select[name='orderWord']").val();
            alert(nhid+":"+infoKey+":"+orderWord);
            $.ajax({
                url:"${pageContext.request.contextPath}/anal/selectNInfo",
                type:"GET",
                data:{"nhid":nhid,"infoKey":infoKey,"orderWord":orderWord},
                success:function(msg){
