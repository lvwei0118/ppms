...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/bao/updateBInfo" method="post" >
     <input type="hidden" value="${nnbx.bxid}" id="bxid" name="bxid">
	<input type="hidden" value="${nnbx.empFk}" name="empFk">
	<input type="hidden" value="${nnbx.bxstatus}" name="bxstatus">
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="2" background="skin/images/tbg.gif">&nbsp;修改报销单&nbsp;</td>
</tr>
