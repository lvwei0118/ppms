...
<script type="text/javascript">
	...
	$(function () {
        ...
        $.ajax({
            ...
            url:"${pageContext.request.contextPath}/emp/getEmpWithMan",
            type:"GET",
            success:function(msg){
                $(msg).each(function (index, item) {
...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/pro/saveInfo" method="POST">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="comname" name="componyname" onchange="changeCeo(this)">
			<option>请选择公司</option>
		</select>
	</td>
</tr>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" name="buildtime"/></td>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select  name="level">
			<option value=1>紧急</option><option value=2>一般</option><option value=3>暂缓</option>
		</select></td>
