...
<tr align="center" bgcolor="#FAFAF1" height="22">
	...
	<c:forEach items="${comp}" var="com" varStatus="vs">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><input name="id" type="checkbox" id="id" value="${com.cid}" class="np"></td>
	<td>${vs.count}</td>
	<td><a href=''><u>${com.company}</u></a></td>
	<td>${com.targetmoney}亿</td>
	<td>${com.business}</td>
	<td>${com.year}</td>
	<td><fmt:formatDate value="${com.startTime}" pattern="yyyy年MM月dd日"/></td>
