...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
		...
		function changeCeo(obj){
            var info=$(obj).val();
            var arr=info.split(',');
			$("#principal").append("<option value='"+arr[2]+"' selected='selected'>"+arr[1]+"</option>");
        }
...
<form name="form2"id="form2" action="${pageContext.request.contextPath}/mod/saveMInfo" method="POST">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="principal" name="analysisFk">
			<option>请选择需求</option>
		</select>
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" name="modname"/></td>
</tr>
<tr >
