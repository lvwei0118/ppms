...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
        ...
        $(function () {
            $.ajax({
                url:"${pageContext.request.contextPath}/pro/listPInfoWithoutNeed",
                type:"GET",
...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/anal/saveNInfo" method="POST">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="proname" name="pronameid">
			<option>请选择添加项目</option>
		</select>
	</td>
</tr>
<tr >
